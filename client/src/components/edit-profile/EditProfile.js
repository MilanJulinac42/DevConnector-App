...
class CreateProfile extends Component {
  ...
  render() {
    ...
    const options = [
      ...
      { label: "Insturctor or Teacher", value: "Insturctor or Teacher" },
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="Company where you work at or your own."
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Tell us your skills, use come to seperate values."
                />
                <TextFieldGroup
                  ...
                  info="If you want your latest repos and a Github linkm include your username."
                />
                <TextAreaFieldGroup
